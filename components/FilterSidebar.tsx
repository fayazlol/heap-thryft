...
const FilterSidebar: FC<FilterSidebarProps> = ({ onFilter }) => {
    const handleFilter = () => {
        ...
        checkboxes.forEach((checkbox) => {
            ...
            } else if (checkbox.dataset.type === "condition") {
    ...
    return (
        <aside className="w-1/4 p-4 border-r border-gray-300 overflow-auto h-screen">
            ...
            <div className="mb-4">
                ...
                <div className="mt-2">
                    {["Tops", "Bottoms", "Outerwear", "Dresses", "Footwear", "Accessories", "Bags"].map((category) => (
                        <div key={category}>
