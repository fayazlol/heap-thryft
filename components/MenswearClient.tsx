...
const MenswearClient: React.FC<MenswearClientProps> = ({ initialListings, user }) => {
  ...
  const fetchListings = async () => {
    try {
      const response = await fetch('/api/filtersidebar/menswear', {
        method: "POST",
        headers: {
